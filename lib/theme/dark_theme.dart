...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color(0xFF4CAF50), // Vert plus clair pour le mode sombre
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFF4CAF50), secondary: Color(0xFF8BC34A)).copyWith(error: const Color(0xFFdd3135)),
